...
require_once('functions/function.php');
  ...
  if(!empty($_POST)){
   ...
   $insert="INSERT INTO menu_section(menu_name ,menu_link,menu_time) VALUES
    ('$menu','$link','$dateis')";
    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                 ...
                 <div class="col-md-3 text-right">
                 	<a href="add-right-menu.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> Add Right Menu</a>
                </div>
          ...
          <div class="panel-body">
              ...
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Munu Link</label>
                <div class="col-sm-8">
